...
public class MaterialButtonSlider extends JButton implements InterfaceButtonSlider {
    ...
    public MaterialButtonSlider(String label, String nameButton, String nameButtonPressed, int wButton, int hButton) {
        super(label);
